// Dead Space 3 Raw Mouse Probe v0.5.2
...
static void report_missing_api(const char* name, const void* p){
    if(p)return;
    status_text("MISSING_API: ");status_text(name);status_text("\r\n");
}
...
static BOOL resolve_apis(){
    ...
    pModule32FirstA=(Module32FirstAFn)resolve_export(k,"Module32First");
    pModule32NextA=(Module32NextAFn)resolve_export(k,"Module32Next");
    pIsWow64Process=(IsWow64ProcessFn)resolve_export(k,"IsWow64Process");
    report_missing_api("KERNEL32!LoadLibraryA",(const void*)pLoadLibraryA);
    report_missing_api("KERNEL32!VirtualAlloc",(const void*)pVirtualAlloc);
    report_missing_api("KERNEL32!VirtualFree",(const void*)pVirtualFree);
    report_missing_api("KERNEL32!VirtualProtect",(const void*)pVirtualProtect);
    report_missing_api("KERNEL32!VirtualQuery",(const void*)pVirtualQuery);
    report_missing_api("KERNEL32!FlushInstructionCache",(const void*)pFlushInstructionCache);
    report_missing_api("KERNEL32!GetCurrentProcess",(const void*)pGetCurrentProcess);
    report_missing_api("KERNEL32!GetCurrentProcessId",(const void*)pGetCurrentProcessId);
    report_missing_api("KERNEL32!GetCurrentThreadId",(const void*)pGetCurrentThreadId);
    report_missing_api("KERNEL32!Sleep",(const void*)pSleep);
    report_missing_api("KERNEL32!QueryPerformanceCounter",(const void*)pQueryPerformanceCounter);
    report_missing_api("KERNEL32!QueryPerformanceFrequency",(const void*)pQueryPerformanceFrequency);
    report_missing_api("KERNEL32!GetLastError",(const void*)pGetLastError);
    report_missing_api("KERNEL32!SetLastError",(const void*)pSetLastError);
    report_missing_api("KERNEL32!CreateToolhelp32Snapshot",(const void*)pCreateToolhelp32Snapshot);
    report_missing_api("KERNEL32!Module32First",(const void*)pModule32FirstA);
    report_missing_api("KERNEL32!Module32Next",(const void*)pModule32NextA);
    ...
    report_missing_api("USER32!RegisterRawInputDevices",(const void*)pRealRegisterRawInputDevices);
    report_missing_api("USER32!GetRawInputData",(const void*)pRealGetRawInputData);
    report_missing_api("USER32!GetRawInputBuffer",(const void*)pRealGetRawInputBuffer);
