...
TYPES = {
    ...
    16:'di8_vtable',17:'mouse_vtable',18:'create_device_enter'
}
...
def main():
    ...
    if magic!=b'DS3DI61\0' or version!=61 or header_size!=HEADER.size or record_size!=RECORD_SIZE:
    ...
    print('DS3 DirectInput + D820 Probe v0.6.1')
    ...
    di8_rows=[]; create_enter_rows=[]; create_rows=[]; fmt_rows=[]; coop_rows=[]; acq_rows=[]; state_rows=[]; data_call_rows=[]; axis_rows=[]; d820_rows=[]; rawreg_rows=[]; iat_rows=[]; vtable_rows=[]
