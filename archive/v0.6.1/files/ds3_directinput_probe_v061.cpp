// Dead Space 3 DirectInput + D820 Probe v0.6.1
...
union PayloadV6 {
    ...
    MetaPayloadV6 meta; IatPayloadV6 iat; VtablePayloadV61 vtable; BYTE pad[472];
};
...
static DWORD WINAPI init_thread(LPVOID){
    ...
    LogHeaderV6 h;zero_bytes(&h,sizeof(h));h.magic[0]='D';h.magic[1]='S';h.magic[2]='3';h.magic[3]='D';h.magic[4]='I';h.magic[5]='6';h.magic[6]='1';h.version=61;h.header_size=sizeof(h);h.record_size=sizeof(LogRecordV6);h.flags=7;h.qpc_frequency=fq.QuadPart;h.image_timestamp=ts;h.image_size=image_size;h.text_rva=text_rva;h.queue_capacity_records=kQueueCapacity;h.flush_interval_ms=kFlushIntervalMs;h.module_rescan_ms=kModuleRescanMs;h.rawreg_poll_ms=kRawRegPollMs;DWORD wrote=0;if(!WriteFile(g_log,&h,sizeof(h),&wrote,0)||wrote!=sizeof(h)){status_text("REFUSED: failed to write binary header.\r\n");return 0;}
